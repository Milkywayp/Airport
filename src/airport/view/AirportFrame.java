...
/**
 * Vista principal del sistema de aeropuerto
 */
...
private void initPassengersTable() {
    ...
    var response = passengerController.getAllPassengers();
    if (response.getStatusCode() == StatusCode.SUCCESS) {
        for (Passenger p : response.getData()) {
            model.addRow(new Object[]{
                p.getId(),
                p.getFirstname() + " " + p.getLastname(), // no getFullname(), concateno
                p.calculateAge()
            });
        }
    }
...
private void initPlanesTable() {
    DefaultTableModel model = (DefaultTableModel) planeTable.getModel();
    model.setRowCount(0);

    var response = planeController.getAllPlanes();
    if (response.getStatusCode() == StatusCode.SUCCESS) {
        for (Plane p : response.getData()) {
            model.addRow(new Object[]{
                p.getId(),
                p.getBrand() + " " + p.getModel(),  // mejor mostrar marca + modelo
                p.getMaxCapacity(),                  // acá es getMaxCapacity()
                p.getAirline(),
                p.getNumFlights()
            });
        }
...
private void initLocationsTable() {
    ...
    if (response.getStatusCode() == StatusCode.SUCCESS) {
        for (Location l : response.getData()) {
            model.addRow(new Object[]{
                l.getCode(),
                l.getAirportName(),
                l.getAirportCity(),
...
private void initFlightsTable() {
    ...
    var response = flightController.getAllFlights();
    if (response.getStatusCode() == StatusCode.SUCCESS) {
        for (Flight f : response.getData()) {
            model.addRow(new Object[]{
                f.getId(),                               // en Flight es getId(), no getFlightNumber()
                f.getPlane().getBrand() + " " + f.getPlane().getModel(),
                f.getDepartureLocation().getAirportCity(),
                f.getScaleLocation() != null ? f.getScaleLocation().getAirportCity() : "—",
    ...
    private void updatePlaneTable() {
        ...
        model.setRowCount(0);
        for (Plane p : planes) {
            model.addRow(new Object[]{p.getId(), p.getModel(), p.getMaxCapacity()});
        }
    }
    ...
    private void updateLocationTable() {
        ...
        for (Location l : locations) {
            model.addRow(new Object[]{l.getCode(), l.getAirportName(), l.getAirportCity()});
        }
    }
    ...
    private void updateFlightTable() {
        ...
        for (Flight f : flights) {
            model.addRow(new Object[]{
                f.getId(),
                f.getPlane().getModel(),
                f.getDepartureLocation().getCode(),
                f.getArrivalLocation().getCode(),
                f.getDepartureDate().toString(),
                f.calculateArrivalDate().toString(),
                f.getNumPassengers()
            });
    ...
    private void blockPanels() {
        //9, 11
        for (int i = 1; i < smf.getTabCount(); i++) {
            if (i != 9 && i != 11) {
                smf.setEnabledAt(i, false);
            }
        }
    }
    ...
    private void initComponents() {
        ...
        panelRound1 = new airport.view.components.PanelRound();
        panelRound2 = new airport.view.components.PanelRound();
        jButton13 = new javax.swing.JButton();
        smf = new javax.swing.JTabbedPane();
        ...
        panelRound3 = new airport.view.components.PanelRound();
        ...
        smf.setFont(new java.awt.Font("Yu Gothic UI", 0, 14)); // NOI18N
        ...
        smf.addTab("Administration", jPanel1);
        ...
        smf.addTab("Passenger registration", jPanel2);
        ...
        smf.addTab("Airplane registration", jPanel3);
        ...
        smf.addTab("Location registration", jPanel13);
        ...
        smf.addTab("Flight registration", jPanel4);
        ...
        smf.addTab("Update info", jPanel5);
        ...
        smf.addTab("Add to flight", jPanel6);
        ...
        smf.addTab("Show my flights", jPanel7);
        ...
        smf.addTab("Show all passengers", jPanel8);
        ...
        smf.addTab("Show all flights", jPanel9);
        ...
        smf.addTab("Show all planes", jPanel10);
        ...
        smf.addTab("Show all locations", jPanel11);
        ...
        smf.addTab("Delay flight", jPanel12);

        panelRound1.add(smf, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 41, 1150, 620));
    ...
    private void administratorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_administratorActionPerformed
        ...
        for (int i = 1; i < smf.getTabCount(); i++) {
            smf.setEnabledAt(i, true);
        }
        smf.setEnabledAt(5, false);
        smf.setEnabledAt(6, false);
        smf.setEnabledAt(7, false);
    ...
    private void userActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_userActionPerformed
        ...
        smf.setEnabledAt(9, true);
        smf.setEnabledAt(5, true);
        smf.setEnabledAt(6, true);
        smf.setEnabledAt(7, true);
        smf.setEnabledAt(11, true);
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        ...
        this.locations.add(new Location(id, name, city, country, latitude, longitude, id));
    ...
    private airport.view.components.PanelRound panelRound1;
    private airport.view.components.PanelRound panelRound2;
    private airport.view.components.PanelRound panelRound3;
    private javax.swing.JTabbedPane smf;
